...
void Matrix4::SetAsUp3Transpose(Matrix4& abc)
{
	values[0] = abc.values[0];
	values[5] = abc.values[5];
	values[10] = abc.values[10];
	values[1] = abc.values[4];
	values[4] = abc.values[1];
	values[2] = abc.values[8];
	values[8] = abc.values[2];
	values[6] = abc.values[9];
	values[9] = abc.values[6];
}